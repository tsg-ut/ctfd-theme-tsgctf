	...
	head: {
		...
		meta: [
			...
			{name: 'viewport', content: 'width=device-width, initial-scale=1'},
			{
				name: 'description',
				hid: 'description',
				content: 'TSG LIVE! CTF 6 is an on-line CTF organized by TSG, the official computer society of The University of Tokyo',
			},
			{name: 'apple-mobile-web-app-title', content: 'TSG LIVE! CTF 6'},
			{name: 'og:title', content: 'TSG LIVE! CTF 6'},
			{name: 'og:site_name', content: 'TSG LIVE! CTF 6'},
			{name: 'og:description', content: 'TSG LIVE! CTF 6 is an on-line CTF organized by TSG, the official computer society of The University of Tokyo'},
			...
			{name: 'twitter:title', content: 'TSG LIVE! CTF 6'},
			{
				name: 'twitter:description',
				content: 'TSG LIVE! CTF 6 is an on-line CTF organized by TSG, the official computer society of The University of Tokyo',
			},
			{name: 'twitter:image', content: `${staticBase}/ogimage.jpg`},
			{name: 'twitter:image:alt', content: 'TSG LIVE! CTF 6'},
		],
