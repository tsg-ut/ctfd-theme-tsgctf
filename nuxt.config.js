	...
	head: {
		...
		meta: [
			...
			{name: 'viewport', content: 'width=device-width, initial-scale=1'},
			{
				name: 'description',
				hid: 'description',
				content: 'TSG LIVE! 6 CTF is an on-line CTF organized by TSG, the official computer society of The University of Tokyo',
			},
			{name: 'apple-mobile-web-app-title', content: 'TSG LIVE! 6 CTF'},
			{name: 'og:title', content: 'TSG LIVE! 6 CTF'},
			{name: 'og:site_name', content: 'TSG LIVE! 6 CTF'},
			{name: 'og:description', content: 'TSG LIVE! 6 CTF is an on-line CTF organized by TSG, the official computer society of The University of Tokyo'},
			...
			{name: 'twitter:title', content: 'TSG LIVE! 6 CTF'},
			{
				name: 'twitter:description',
				content: 'TSG LIVE! 6 CTF is an on-line CTF organized by TSG, the official computer society of The University of Tokyo',
			},
			{name: 'twitter:image', content: `${staticBase}/ogimage.jpg`},
			{name: 'twitter:image:alt', content: 'TSG LIVE! 6 CTF'},
		],
